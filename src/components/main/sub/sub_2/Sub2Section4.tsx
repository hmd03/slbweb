...
import { menusByCategory } from '../../../../menulist';
import MenuGrid from '../../../ui/table/MenuGrid';
  ...
  return (
    ...
    >
      ...
      >
        {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
          ...
          <>
            ...
            <p>
              <span className='font-medium'>우리나라 전통 식문화를 접목</span>한
              요리를 연구하고 개발해
            </p>
            <p>독보적인 메뉴 경쟁력을 갖추고 있습니다.</p>
          </>
        ...
        <img
          ...
          className={`${
            deviceInfo.isSmallScreen || deviceInfo.isMobile
              ...
              : 'flex-1 aspect-[1434/864] max-w-[800px]'
          } w-full`}
          alt={`독보적 메뉴 = 높은 매출!`}
      ...
      >
        <MenuGrid
          menu={menus[1]}
          isSmallScreen={deviceInfo.isSmallScreen || deviceInfo.isMobile}
        />
        <MenuGrid
          menu={menus[2]}
          isSmallScreen={deviceInfo.isSmallScreen || deviceInfo.isMobile}
