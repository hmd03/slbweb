...
const Sub2Section1: React.FC<Sub2Section1Props> = ({ onIframeLoad }) => {
  ...
  return (
    ...
    >
      ...
      >
        <span className={`flex`}>
          고객들의 외식 선택 요소 변화가 ‘샐러드 & 포케’시장의 성장으로 이어지고
          있습니다.
        </span>
      </div>
      <div
        className={`${
          deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'mb-10' : ' mb-40'
        ...
        >
          {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
            ...
            <>
              ...
              <p>
                SLB는 한국인이 가장 많이 섭취하는 한식을 샐러드&포케 등 다양한
                메뉴에 접목해
              </p>
              <p>시장 경쟁력을 더 높이고 있습니다</p>
            </>
      ...
      >
        ...
        >
          {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
            ...
            <>
              <p className='font-medium'>
                전 연령대 모두 신체/정신 건강에 대한 폭넓은 관심과 관리 노력!
              </p>
              <p>
                건강 관리 5대 관심 분야 : 수면, 식단 관리, 스트레스 관리, 체중
                감량 방법, 운동 방법
              </p>
            </>
          )}
