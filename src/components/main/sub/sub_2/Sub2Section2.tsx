    ...
    >
      ...
      >
        {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
          ...
          <>
            <p>
              고객들의 입맛은 냉정하다! 아무리 건강해도 ‘맛’이 없다면 소비하지
              않습니다.
            </p>
            <p>
            ...
            <p>샐러드&포케와 접목한 메뉴를 개발해 고객 재방문을 높였습니다.</p>
          </>
        )}
      </div>
      <div
        className={`${
          deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'my-10' : 'my-40'
