      ...
      >
            ...
            >
              {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                ...
                <>
                  <p>인테리어가 좋다는 것은 단순히 디자인만 좋다가 아닙니다.</p>
                  <p>
                    브랜드가 추구하는 컨셉을 얼마나 잘 녹여져 있는지 고객의
                    5감을 만족시킬 수 있는
                  </p>
                  <p>
                ...
                {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                  ...
                  <>
                    <p>
                      ...
                      강화하기 위해 모던함에 한국의 전통적인 정신을 계승하기
                      위해 비움과 절제의 미학을 반영했고,
                    </p>
                    <p>
                    ...
                    <p>
                      또한, 요리 퍼포먼스와 청결함을 고객에게 확인시켜 줄 수
                      있는 오픈 키친으로 고객에게 좋은 인상을 남기고 있습니다.
                    </p>
                    <p>
        ...
        {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
          ...
          <>
            ...
            >
              <div
                className={` rounded-tr-[5rem] rounded-bl-[5rem] max-w-[800px] max-h-[600px] mr-[25vw] w-full h-full bg-[#E3E3E4]  leading-none`}
              >
                <div
