        ...
        >
                ...
                >
                    ...
                    >
                        {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                            <>
                                <p>
                                    인테리어가 좋다는 것은 단순히 디자인만
                                    좋다가 아닙니다.
                                </p>
                                <p>
                                    브랜드가 추구하는 컨셉을 얼마나 잘 녹여져
                                    있는지
                                </p>
                                <p>
                                    고객의 5감을 만족시킬 수 있는 인테리어
                                    전략이 있어야만
                                </p>
                            ...
                            <>
                                ...
                                <p>
                                    브랜드가 추구하는 컨셉을 얼마나 잘 녹여져
                                    있는지 고객의 5감을 만족시킬 수 있는
                                </p>
                                <p>
                                    인테리어 전략이 있어야만 높은 매출이 나오는
                                    성공한 맛집이 됩니다.
                                </p>
                            </>
                        )}
                        ...
                        >
                            {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                                <>
                                    ...
                                    <div className='mt-4 mb-8 flex flex-col text-center'>
                                        <p>
                                            SLB는 단순한 유행을 따라가는 것이
                                            아닌
                                        </p>
                                        <p>
                                            SLB만의 '힙'함을 브랜드에 녹여내기
                                            위해
                                        </p>
                                        <p>
                                            오랜 시간 고민하고 수많은 디자인
                                ...
                                <>
                                    <p>
                                        프리미엄 한식X샐러드&포케 전문
                                        브랜드로서 고객 경험을 강화하기 위해
                                        모던함에 한국의 전통적인 정신을 계승하기
                                        위해 비움과 절제의 미학을 반영했고,
                                    </p>
                                    <p>
                                        우리 민족이 가장 좋아하고 숭상하는 빛,
                                        순수함, 깨끗함을 뜻하는 흰색을 메인
                                        컬러로 활용해 SLB만의 인테리어 디자인을
                                        완성했습니다.
                                    </p>
                                    <p>
                                        또한, 요리 퍼포먼스와 청결함을 고객에게
                                        확인시켜 줄 수 있는 오픈 키친으로
                                        고객에게 좋은 인상을 남기고 있습니다.
                                    </p>
                                    <p>
                                        SLB는 단순한 유행을 따라가는 것이 아닌
                                        SLB만의 '힙'함을 브랜드에 녹여내기 위해
                                        오랜 시간 고민하고 수많은 디자인 트렌드
                                        연구를 통해 현재의 인테리어 디자인을
                                        개발 할 수 있었습니다.
                                    </p>
                                </>
                            )}
            ...
            {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                        ...
                        >
                            ...
                            >
                                <>
                                    ...
                                    />
                                    <p className='Slb-Title-mo leading-normal text-[#FF331F] mb-10'>
                                        SLB에게 가맹점은 ‘돈’벌이 수단이 아닌
                                        ‘가족’입니다.
                                    </p>
                                </>
                            </div>
                ...
                <>
                    ...
                    >
                        <div
                            className={` rounded-tr-[5rem] rounded-bl-[5rem] max-w-[845px] max-h-[680px] mr-[25vw] w-full h-full bg-[#E3E3E4]  leading-none`}
                        >
                            <div
                                className={` text-slbSubTitle font-normal w-full h-full p-8 items justify-between break-keep flex flex-col`}
                            >
                                <>
                                    <p className=' leading-normal'>
                                        SLB는 가맹점의 매출 및 수익성을 높이기
                                    ...
                                    <p className='Slb-Title leading-normal text-[#FF331F]'>
                                        SLB에게 가맹점은 ‘돈’벌이 수단이 아닌
                                        ‘가족’입니다.
                                    </p>
                                </>
            ...
            <div
                className={`${
                    deviceInfo.isSmallScreen || deviceInfo.isMobile
                        ? 'Slb-Content-mo mt-10 flex-col gap-1 text-center'
                        : 'Slb-Content mt-20 gap-2'
                } flex`}
            >
                <p>
                    ‘인테리어 직거래 시스템’으로<p></p>프리미엄 인테리어 공간을
                </p>
            </div>
            <div
                className={`${
            ...
            >
                <img
                    ...
                    className={`${
                        deviceInfo.isSmallScreen || deviceInfo.isMobile
                            ? 'mb-10 aspect-[580/894]'
                            : 'mb-60 aspect-[880/430]'
                    }`}
