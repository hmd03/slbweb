        ...
        >
            ...
            <SlideUpOnView>
                ...
                {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                    <>
                        ...
                        >
                            <p
                                className={`Slb-Point-mo mr-1 text-[#FF331F] leading-none`}
                            >
                                '식구'
                            </p>
                            라 쓰는 이유?
            ...
            >
                {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                    ...
                    <>
                        <p>
                            점주님도 SLB 본사가 없다면 존재할 수 없듯이 본사는
                            점주님들이 없다면 존재할 수 없기 때문!
                        </p>
                        <p>
                            SLB는{' '}
                            <span
