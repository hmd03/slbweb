    ...
    return (
        ...
        >
            ...
            <div className='w-full flex justify-center p-8'>
                <img
                    src={`${process.env.PUBLIC_URL}/sub_3/sub_3_2.webp`}
                    alt='SLB 경험의 시작'
                    className='max-w-[1100px] w-full h-auto object-cover rounded-lg'
                    loading='lazy'
                />
            </div>
            {/* <div
                ...
                >
                    {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                        <>
                            ...
                            <p>
                                창업하고 싶다는 것이 예비창업자들의 생각입니다.
                            </p>
                        </>
                    ) : (
                        <>
                            <p>
                                창업 하고 싶어하는 예비창업자의 창업 의지는
                                여전히 높다
                            </p>
                            <p>
                                <span className='font-medium'>
                        ...
                        >
                            {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                                ...
                                <>
                                    ...
                                    <p>
                                        건강하고 가벼운 샐러드&포케로 나만의
                                        총량을 맞추고
                                    </p>
                                    <p>
                                        식사와 건강 균형을 위해 음식의 칼로리 및
                                        영양성분 필이 확인!
                                    </p>
                                </>
                            )}
