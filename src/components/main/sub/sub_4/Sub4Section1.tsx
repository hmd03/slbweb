...
const Sub4Section1: React.FC = () => {
  ...
  const desc = [{img:`${process.env.PUBLIC_URL}/sub_4/sub_4_1_8.webp`, alt:'SLB는 QSC(가맹점의 메뉴 매뉴얼, 고객 서비스, 매장 청결)를 전담 슈퍼바이저를 통해 주기적으로 점검해 고객에게 최상의 메뉴와 서비스를 제공 할 수 있도록 지원하고 있습니다'},
    {img:`${process.env.PUBLIC_URL}/sub_4/sub_4_1_9.webp`, alt:'SLB는 SNS채널을 통해 SLB의 브랜드 및 가맹점 정보를 알리고 고객과 소통하며 고객에게 사랑 받을 수 있는 브랜드가 되도록 노력하고 있습니다.'},
    {img:`${process.env.PUBLIC_URL}/sub_4/sub_4_1_10.webp`, alt:'SLB는 체험단 운영을 통해 각 가맹점을 홍보할 수 있도록 지원하고 있으며, 검색 포털 지도 검색 등 추가 홍보수단을 본사가 통합 관리해 가맹점 매출을 높이는 노력을 진행 중입니다.'},
    {img:`${process.env.PUBLIC_URL}/sub_4/sub_4_1_11.webp`, alt:'SLB는 각 매장 별 전담 슈퍼바이저를 통해 주변 상권분석, 경쟁사 분석, 고객 동선 분석 등을 통해 가장 적합한 매장 홍보 방안을 제안해 가맹점 매출과 수익을 높일 수 있도록 지원하고 있습니다.'} 
  ];
  return (
    <section
      id='section-1'
