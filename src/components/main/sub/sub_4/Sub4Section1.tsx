        ...
        >
            ...
            >
                {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                    ...
                    <>
                        <p>
                            빅데이터 분석을 통한 전문적인 상권분석으로 최적의
                            매장 입지를 선정할 수 있도록
                        </p>
                        <p>
                            10년 이상의 상권분석 노하우를 가진 전문가를 지원하고
                            있습니다
                        </p>
                    </>
                )}
                ...
                <SlideUpOnView>
                    {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                        <>
                            ...
                            >
                                <p className='Slb-Point-mo'>안정적인 매출</p>을
                                지속적으로
                            </div>
                            <div
                                className={`${
                        ...
                        <>
                            ...
                            >
                                <p className='Slb-Point'>안정적인 매출</p>을
                                지속적으로
                            </div>
                            <div
                                className={`${
            ...
            >
                {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                    ...
                    <>
                        <p>
                            SLB는 모든 메뉴가 '맛'있다고 자부하지만 '맛'만
                            있다고
                        </p>
                        <p>[맛집]이 되는 것은 아닙니다.</p>
                        <p>
                            많은 고객이 SLB의 '맛'있는 메뉴들을 드셔볼 수 있도록
                        </p>
                        <p className='font-medium'>
                            본사와 가맹점주 모두의 노력이 필요합니다.
                        </p>
