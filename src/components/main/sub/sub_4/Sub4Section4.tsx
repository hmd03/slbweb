...
const Sub4Section4: React.FC = () => {
  ...
  const itemData = [
    ...
    },
    {
      ...
      desc: [
        `트렌드 분석을 통해 경쟁력 높은 메뉴 개발을 지속 적으로 실시하며, 주기적인 신메뉴 출시를 통해 고객 만족도를 높여 매출을 향상 시킵니다.
`,
      ],
    },
    {
      ...
      highlight: '물류공급',
      desc: [
        `신선 제품의 안정적인 공급을 위해 당일 배송을 원 칙으로 하며 친환경 무농약 채소 계약 재배를 통해 제품을 안전하고 빠르게 공급해 드립니다. (주 6회 배송, 일부 지역 제외)`,
      ],
    },
    {
      number: '4',
        ...
        <div
          className={`${
            deviceInfo.isSmallScreen || deviceInfo.isMobile
              ...
              : 'flex-col items-center gap-2 leading-none mb-60'
          } flex`}
        >
          <p>가맹점주님이 진심으로</p>
