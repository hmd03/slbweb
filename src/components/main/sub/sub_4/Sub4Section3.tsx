...
const Sub4Section3: React.FC = () => {
  ...
  const item = [
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_9.webp` , 
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_8.webp` , 
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_7.webp` , 
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_2.webp` , 
      alt:`인테리어 공사
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_3.webp` , 
      alt:`가맹점주 본사 교육
      매장 운영에 필요한 메뉴 조리 교육,
      설비 조작법 습득 교육, 고객 서비스
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_4.webp` , 
      alt:`최종 점검
      지정 슈퍼바이저 파견을 통한
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_6.webp` , 
      alt:`오픈
      가맹점주님 매장을 전담하게 될
      담당 슈퍼바이저를 파견해
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_5.webp` , 
      alt:`개설 상담 예비 가맹점주님의 자금과
      현재 상황에 맞는 가장 적합한
      1:1 맞춤 창업상담을 통해
      SLB 창업비용, 매출, 수익성을
    ...
    {
      img:`${process.env.PUBLIC_URL}/sub_4/sub_4_3_1_1.webp` , 
      alt:`사후 관리 및 운영 지원
      오픈 이후 담당 슈퍼바이저의
      정기 방문을 통한 운영 지원 및
      매출에 대한 지속적인 관리가
  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'Slb-Point-mo' : 'Slb-Point gap-2 my-2'
      ...
      <div
        className={`${
          deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'Slb-Point-mo' : 'Slb-Point gap-2 mb-20'
        } flex items-end leading-none`}
      >
        <p
          className={`${
