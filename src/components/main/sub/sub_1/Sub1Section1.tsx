            ...
            <div className='relative w-full max-w-full z-10 px-4 mt-12'>
              ...
              <div className='mt-8'>
                <p className='text-white text-[clamp(1.5rem,6vw,3.5rem)] font-bold leading-tight'>
                  <span className='text-[#FF331F]'>맛</span>에 대한{' '}
                  <span className='text-[#FF331F]'>고집이</span>
                </p>
                <p className='text-white text-[clamp(1.5rem,6vw,3.5rem)] font-bold leading-tight'>
                  <span className='text-[#FF331F]'>남다른 특별함</span>을
                  만든다!
                </p>
              </div>
            </div>
        ...
        >
          {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
            <>
              ...
              <p>건강한 조리법까지 활용해</p>
              <p>
                <span className='font-medium'>SLB만의 특별한 [맛의 정의]</span>
                를 만들어 갑니다.
              </p>
              <div
                className={`${
              ...
              />
              <p className='font-medium'>새로운 시장을 개척하는 트렌드 리더</p>
