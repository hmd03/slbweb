  ...
  const itemData = [
    ...
    },
    {
      ...
      desc: [
        ...
        '그렇기 떄문에 /노동강도가 낮으면서도 인력을 최소화 할 수 있는 창업 아이템을 고르는 것이 중요/합니다. 단순히 노동강도가 낮다고 고르기보다 /매출 구조를 꼼꼼히 따져보는 것이 중요/합니다. 막상 노동강도가 낮다고 창업했지만 매출과 수익성이 높지 않은 경우가 많기 때문입니다.',
      ],
    },
  ];
    ...
    <div>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/sub_1/sub_1_1_1.webp)`,
          }}
        ></div>
        ...
        >
          ...
          <div
            className={`${
              deviceInfo.isSmallScreen || deviceInfo.isMobile ? '' : ''
            } absolute top-0 left-0 w-[1px] h-full bg-black`}
          />
          {/* 오른쪽 세로줄 */}
          <div
            className={`${
              deviceInfo.isSmallScreen || deviceInfo.isMobile ? '' : ''
            } absolute top-0 right-0 w-[1px] h-full bg-black`}
          />

          {/* 위쪽 귀퉁이 */}
          <div
            className={`${
              deviceInfo.isSmallScreen || deviceInfo.isMobile ? '' : 'w-[60px] '
            } absolute top-0 left-0 h-[2px] bg-black`}
          />
          <div
            className={`${
              deviceInfo.isSmallScreen || deviceInfo.isMobile ? '' : 'w-[60px] '
            } absolute top-0 right-0 h-[2px] bg-black`}
          />
          ...
          <div
            className={`${
              deviceInfo.isSmallScreen || deviceInfo.isMobile ? '' : 'w-[60px] '
            } absolute bottom-0 right-0 h-[2px] bg-black`}
          />
          ...
          >
            ...
            <p
              className={`${
                deviceInfo.isSmallScreen || deviceInfo.isMobile ? '' : 'mb-6'
              }`}
            >
              우리나라 한식이 가지고 있는 특유의 정성과 세심함으로
            </p>
            <p>식재료 선별은 물론 식재료의 궁합과 건강한 조리법까지 활용해</p>
            <p>
              <span className='font-medium'>SLB만의 특별한 [맛의 정의]</span>를
              만들어 갑니다.
            </p>
            <div
              className={`${
            ...
            <p className='font-medium'>
              새로운 시장을 개척하는 트렌드 리더 한식X샐러드&amp;포케 전문점 SLB
            </p>
          </div>
        </div>
        <div
          ...
          >
            <div
              className={`${
                deviceInfo.isSmallScreen || deviceInfo.isMobile
                  ? 'Slb-Content-mo'
                  : 'Slb-Content mt-20 w-[1300px] items-center justify-center gap-8'
              } flex`}
            >
              {['G', 'A', 'H', 'O'].map((v) => (
                <div
      ...
      >
        ...
        <div
          className={`${
            deviceInfo.isSmallScreen || deviceInfo.isMobile
              ? ''
              : 'max-w-[1300px] w-[100%] mt-20 gap-10'
          } flex`}
        >
          <img
            loading='lazy'
            ...
            src={`${process.env.PUBLIC_URL}/sub_1/sub_1_2_1.webp`}
          />
          <div
            className={`${
              deviceInfo.isSmallScreen || deviceInfo.isMobile
          ...
          >
            ...
            >
              <p>
                보통의 외식브랜드가 단순히 ‘맛’을 위해 노력하고 있을 때, SLB는
                다른 고민을 합니다.
              </p>
              <p>
                건강한 음식은 맛없다는 편견을 바꾸기 위해 건강하지 못한 식습관을
                개선하기 위한 노력과 바쁨으로 요리하는 사람도 먹는 사람도 만족할
                수 있도록 맛과 건강에 특화된 한국의 ‘식(食)’ 문화를 기반으로
                SLB다운 ‘맛의 정의’를 개발해 샐러드&포케로 새로운 외식 문화를
                만들어 갑니다.
              </p>
              <p>
        ...
        <div
          className={`${
            deviceInfo.isSmallScreen || deviceInfo.isMobile ? '' : 'mt-40 pb-40'
          } bg-no-repeat bg-center bg-cover flex flex-col items-center w-full h-fit`}
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/sub_1/sub_1_2_3_background.webp)`,
          }}
        >
                ...
                >
                  <div
                    className={`${
                      deviceInfo.isSmallScreen || deviceInfo.isMobile
                        ? 'Slb-Content-mo'
                        : 'Slb-Content text-DeepGray mb-8'
                    }`}
                  >
                    {item.number}
                  </div>
      ...
      >
              ...
              <div
                ...
                className={`${
                  deviceInfo.isSmallScreen || deviceInfo.isMobile
                    ? ''
                    : 'max-w-[1300px] w-[100%] gap-10 py-10'
                } flex ${idx === 0 ? '' : 'border-t-[1px]'} border-Black`}
              >
                <img
                  loading='lazy'
                  className={`${
                    ...
                    >
                      <div
                        className={`${
                          deviceInfo.isSmallScreen || deviceInfo.isMobile
                            ? 'Slb-Content-mo'
                            : 'flex items-center justify-center w-6 h-6 rounded-full bg-black text-white text-sm'
                        }`}
                      >
                        {item.number}
                      </div>
        ...
        >
          ...
          >
            예비창업자님들의
            <span className={`flex`}>
              <span className='font-medium'>인력을 최소화 할 수 있는 구도</span>
              입니다.
            </span>
          </div>
        </div>
        <div
          ...
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/sub_1/sub_1_3_2.webp)`,
          }}
        />
      </section>
      <section
        ...
        >
          ...
          >
            ...
            >
              ...
              <p>SLB는 신규 점주님 매장 오픈 전부터 메뉴 완성도 확인</p>
              <p>오픈 전 체크사항 미리 확인하고 도움을 드리고 있습니다.</p>
            </div>
          </div>
        </div>
        <div
