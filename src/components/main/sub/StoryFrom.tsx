        ...
        >
            ...
            >
                {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                    ...
                    <>
                        <p>
                            한식을 기반으로 식재료 선택부터 재료의 궁합, 최적의{' '}
                        </p>
                        <p>
                            조리 방법까지 고민합니다. 더 나은 음식의 ‘맛’을 내기{' '}
                        </p>
                        <p>위해 SLB는 현재에 만족하지 않습니다.</p>
                        <p>
                            고객의 삶 속에서 발생하는 건강에 대한 고민을
                            음식으로
                        </p>
                        <p>
                            도움을 드리고 삶의 균형을 찾길 원하는 마음으로
                            진심을
                        </p>
            ...
            >
                ...
                >
                    {deviceInfo.isSmallScreen || deviceInfo.isMobile ? (
                        ...
                        <>
                            <p>
                                신체적, 정신적 건강 고민만 하고 실천은 쉽지 않은
                                우리!
                            </p>
                            <p>
                                SLB는 일상을 살아가기 위해 가장 많이 하고 있는
                                [식食] 행위를 통해
                            </p>
                            <p>
                                고객에게 더 나은 삶의 방향과, 균형을 찾아 드리고
                                싶은 의지를 담아
                            </p>
                            <p>
                                강한 의지의 표현{' '}
                            ...
                            <p className='mt-10'>
                                샐러드&포케에 익숙한 한식을 더해 누구나 쉽게
                                접할 수 있고
                            </p>
                            <p>
                                건강한 삶의 균형을 찾을 수 있도록 도전을 멈추지
                                않는
                            </p>
                            <p className='font-medium mb-10'>
                                한식X샐러드&포케전문 브랜드 SLB
                            </p>
                            <p className='Slb-Title'>
                                고객을 위한 도전은 계속 됩니다!
                            </p>
                        </>
                    )}
