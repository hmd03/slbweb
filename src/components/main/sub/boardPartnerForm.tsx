...
const BoardPartnerForm: React.FC = () => {
  ...
  const tableHeadStyle = `bg-LightGray font-semibold text-left break-keep ${deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'text-[12px] pt-2 pl-1' : 'text-detail pl-4 pt-4'} w-[30%]`;
    ...
    <div className='w-full flex justify-center px-4 py-8 bg-white'>
      <div className='w-full max-w-[1300px]'>
        <div className='flex flex-col items-center justify-center mb-6'>
          ...
          >
            SLB와의 <span className='text-Point'>협력, 제안 사항</span>은
          </p>
          <p
            className={`${
              deviceInfo.isMobile || deviceInfo.isSmallScreen
