...
const InquiryForm: React.FC = () => {
  ...
  const tableHeadStyle = `bg-LightGray font-semibold text-left break-keep w-[40%] ${deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'text-[14px] pt-2 pl-1' : 'text-detail pt-4 pl-4'}`;
