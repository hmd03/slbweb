  ...
  return (
    <div className='flex justify-between items-center w-full bg-Black h-[4rem] fixed top-0 left-0 z-10'>
      ...
      <div className='m-[1rem] flex'>
        <OutlineButton 
          theme='admin' 
          className={`h-[3rem] flex items-center bg-White ${!deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'w-[12rem] px-5 ' : 'w-[3rem] justify-center'}`} 
        ...
        <OutlineButton 
          theme='admin' 
          className={`h-[3rem] flex items-center bg-White ${!deviceInfo.isSmallScreen || deviceInfo.isMobile ? 'w-[8rem] px-5 ' : 'w-[3rem] justify-center'}`} 
