                    ...
                    <tbody className='bg-White text-diagram'>
                        {data.map((item, index) => (
                            <tr key={item.id}>
                                ...
                                <td className="border border-Black border-[2px] p-2 text-center w-[10%]">{item.id}</td>
                                ...
                                <td className="border border-Black border-[2px] p-2 text-center w-[10%]">{item.name}</td>
                                <td className="border border-Black border-[2px] p-2 text-center w-[10%]">{formatDate(item.createdAt)}</td>
