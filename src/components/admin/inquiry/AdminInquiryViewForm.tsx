        ...
        <table className='min-w-full border-collapse border border-[2px] border-Black'>
          ...
          <tbody className='text-diagram'>
            ...
            <tr>
              ...
              <td className={tdClassName}>{item.preferredRegion}</td>
            </tr>
            {item.category === '온라인 창업 문의' && (
              <>
                <tr>
                  <th className={thClassName}>연령대</th>
                  <td className={tdClassName}>{item.ageGroup}</td>
                </tr>
                <tr>
                  ...
                  <td className={tdClassName}>{item.discoveryRoute}</td>
                </tr>
                <tr>
                  <th className={`${thClassName} p-10`}>문의 내용</th>
                  <td className={tdClassName}>{item.content}</td>
                </tr>
              </>
            )}
            <tr>
